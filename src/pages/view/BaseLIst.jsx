        ...
        <div className={styles.page}>
          ...
          <Container type="leftSide">
            <div>
              ...
              <DashFlexList asterisk label="묵 도" tail="다 같 이" />
              <DashFlexList asterisk label="기 원" tail="인 도 자" />
              <DashFlexList
                asterisk
                label="찬 송"
                tail="다 같 이"
            ...
            <div>
              ...
              />
              <DashFlexList label="대 표 기 도" tail="신 승호 집사" />
              <DashFlexList
                label="성 경 봉 독"
                tail="황 맹심 전도사"
          ...
          <Container type="rightSide" className={styles.backRightSide}>
            <p className={styles.infoText}>
              ...
              "야곱아 너를 창조하신 여호와께서 이제 말씀 하시느니라. 이스라엘아
              너를 조성하신 자가 이제 말씀하시느니라. 너는 두려워 말라. 내가
            ...
            <div className={styles.contentBoxWrap}>
              <div className={styles.contentBoxRow}>
                ...
                <div className={styles.contentBox}>
                  ...
                  <DashFlexList part2 label="묵 도" tail="담임 목사" />
                  <DashFlexList
                    part2
                    label="찬 송"
                  ...
                  />
                  <DashFlexList part2 label="기 도" tail="인 도 자" />
                  <DashFlexList
                    part2
                    label="찬 송"
                    tail="다 같 이"
                  ...
                  />
                  <DashFlexList part2 label="축 도" tail="담임 목사" />
                </div>
                {/* E : 주일 찬양 예배 */}
        ...
        <div className={styles.page}>
          ...
          <Container type="leftSide" className={styles.notice}>
            <div>
              ...
              <ol className={styles.noticeLIst}>
                ...
                <li>
                  <span>3.</span>
                  <span>
                    전도 목표 : 장년 50명, 청년 20명, 중고등부 10명 씩, 초등부
                    20, 유치부가 세워질 수 있도록 기도하면서 전도하시길
                    바랍니다.
                  </span>
                </li>
                <li>
                  <span>4.</span>
                  <span>
                    환난을 당한 성도나 교회에 보이지 않는 성도들을 위해
                    기도하시고 찾아가 위로와 권면이 있으시길 바랍니다.
                  </span>
                </li>
                {notice.map((el, idx) => {
                  return (
            ...
            <div className={styles.bibleWord}>
              ...
              <p>
                {/* eslint-disable-next-line react/no-unescaped-entities */}
                "여호와는 내게 복을 주시고 너를 지키시기를 원하며
                <br />
                여호와는 그 얼굴로 내게 비취사 은혜 베푸시기를 원하며
                <br />
                {/* eslint-disable-next-line react/no-unescaped-entities */}
                여호와는 그 얼굴로 네게로 향하여 드사 평강주시기를 원하노라."
                (민.6:24~26)
              </p>
            </div>
            ...
            <div>
              ...
              <ol className={styles.noticeLIst}>
                ...
                <li>
                  <span>4.</span>
                  <span>
                    영광교회 주변의 믿지 않는 불신자들을 위해서 기도해 주시길
                    바랍니다.
                  </span>
                </li>
              </ol>
